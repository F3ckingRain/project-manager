...
/**Поле "Комментарий". */
export function Comment (): React.JSX.Element {
    const fieldKey: keyof ITestCase = 'comment';
    ...
    const handleBlur = (newValue: string): void => {
        ...
        dispatch(validateFieldAction({ key: fieldKey, schema: commentSchema, value: newValue }));
    }
