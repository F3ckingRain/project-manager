...
import { preConditionSchema } from "./Schema";
import { validationErrorsSelector } from "../../Redux/Validation/Selectors";

/**Поле "Предусловие". */
export function PreCondition (): React.JSX.Element {
    const fieldKey: keyof ITestCase = 'preCondition';
    ...
    const handleBlur = (newValue: string): void => {
        ...
        dispatch(validateFieldAction({ key: fieldKey, schema: preConditionSchema, value: newValue }));
    }
