...
import { postConditionchema } from "./Schema";
import { validationErrorsSelector } from "../../Redux/Validation/Selectors";

/**Поле "Постусловие". */
export function PostCondition (): React.JSX.Element {
    const fieldKey: keyof ITestCase = 'postCondition';
    ...
    const handleBlur = (newValue: string): void => {
        ...
        dispatch(validateFieldAction({ key: fieldKey, schema: postConditionchema, value: newValue }));
    }
